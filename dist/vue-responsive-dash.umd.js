...
// load the styles
var content = __webpack_require__(7637);
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.id, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = (__webpack_require__(4402)/* ["default"] */ .Z)
var update = add("3a61f6da", content, true, {"sourceMap":false,"shadowMode":false});
...
var DashLayoutvue_type_template_id_c6bf3750_scoped_true_withScopeId = function _withScopeId(n) {
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.pushScopeId)("data-v-c6bf3750"), n = n(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.popScopeId)(), n;
};
...
function DashLayoutvue_type_template_id_c6bf3750_scoped_true_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.currentBreakpoint === $props.breakpoint ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", DashLayoutvue_type_template_id_c6bf3750_scoped_true_hoisted_1, [$data.l ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", {
    key: 0,
    style: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeStyle)({
      position: 'relative',
    ...
    _: 3
  }, 8, ["id", "y", "height", "maxWidth"]), [[external_commonjs_vue_commonjs2_vue_root_Vue_.vShow, $options.dragging || $options.resizing]])], 4)) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true), $props.debug ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", DashLayoutvue_type_template_id_c6bf3750_scoped_true_hoisted_3, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)(" Layout Breakpoint: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($props.breakpoint) + " ", 1), DashLayoutvue_type_template_id_c6bf3750_scoped_true_hoisted_4, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)(" Layout Number of Cols: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($props.numberOfCols) + " ", 1), DashLayoutvue_type_template_id_c6bf3750_scoped_true_hoisted_5, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)(" placeholder: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(JSON.stringify($options.placeholder)) + " ", 1), DashLayoutvue_type_template_id_c6bf3750_scoped_true_hoisted_6, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)(" Items: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(JSON.stringify($options.itemsFromLayout)) + " ", 1), DashLayoutvue_type_template_id_c6bf3750_scoped_true_hoisted_7, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)(" Height: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)($options.height) + " ", 1), DashLayoutvue_type_template_id_c6bf3750_scoped_true_hoisted_8, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)(" Attrs: " + (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(_ctx.$attrs), 1)])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true);
}
...
var DashLayoutvue_type_style_index_0_id_c6bf3750_scoped_true_lang_css = __webpack_require__(5285);
...
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-85.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[4]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/Dashboard.vue?vue&type=template&id=4892049d
...
function Dashboardvue_type_template_id_4892049d_render(_ctx, _cache, $props, $setup, $data, $options) {
  var _directive_rlocal = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.resolveDirective)("rlocal");
  return $data.d ? (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withDirectives)(((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", {
    key: 0,
    id: $props.id,
    ref: $props.id,
  ...
  }, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderSlot)(_ctx.$slots, "default")], 40, Dashboardvue_type_template_id_4892049d_hoisted_1)), [[_directive_rlocal]]) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true);
}
